...
public class PauseMenu : MonoBehaviour
{
    ...
    public GameObject TutorialScreen; // GameObject for the Players Control Screen
    ...
    private void Update()
    {
        ...
        if (SettingsScreen.activeInHierarchy || TutorialScreen.activeInHierarchy)
        {
            ...
            if (Input.GetButtonDown("Pause"))
            {
                ...
                TutorialScreen.SetActive(false); // Controls Screen is seto to false when "Escape" key is pressed
            }
        }
        #endregion
    }
